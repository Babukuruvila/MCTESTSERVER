...
PICS = (environ.get('PICS', 'https://graph.org/file/eba20e5d07f3453c3b69d.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001856766245').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://test20:test20@cluster0.iaojbks.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# FSUB
auth_channel = environ.get('AUTH_CHANNEL', '-1002130513813')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1002130513813")
